...
class SelectCommon extends React.Component {
  ...
  render() {
    ...
    <img src={`../../static/${option.src}`} alt={option.label} height="22" width="22"></img> &nbsp; &nbsp;{option.label} <span style={{float: "right"}}>
              {option.value === this.props.tokenName ? this.props.balance || '': ''}
              </span> 
            </MenuItem>
          ))}
        </TextField>
